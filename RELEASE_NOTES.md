...
- In-app OpenRouter chat is the only assistant UI. Embedded Codex, Antigravity, and GitHub Copilot CLIs were removed. Optional MCP clients such as Claude Desktop can still use `http://127.0.0.1:8080/mcp` as `fm-ai-assistent`.
...
- Squad advice: `fm26_sell_shortlist`, `fm26_wonderkid_shortlist`, `fm26_compare_squads`, `fm26_compare_players`, `fm26_best_xi`, plus Squad trim / First XI / Chat views. Snapshots persist in file-backed H2 next to the settings file.
